...
# ── needle_slow_targets ──────────────────────────────────────────────────────
assert_lines "target table lists 25 names" 25 needle_slow_targets
...
SLOW_TARGET=""
assert_lines "default selection is all 24 cargo targets" 24 selected_cargo_targets
