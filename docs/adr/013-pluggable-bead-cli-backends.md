...
- **2026-08-12, accepted.** Operator accepted the decision as written in draft 4. Phase 16 is now authorized work rather than a proposal the fleet was executing against ahead of a decision. The staged-rollout item (`bf-4rdm5`) is load-bearing on the way in: this ADR changes the claim path for every backend, and NEEDLE's own coordination substrate is one of the workspaces being migrated.
